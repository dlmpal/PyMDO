...
from pymdo.core.constants import FLOAT_DTYPE, COMPLEX_DTYPE
from pymdo.core.variable import Variable
from pymdo.cache import CachePolicy, CacheType, create_cache
from pymdo.utils.array_and_dict_utils import verify_dict_1d, verify_dict_2d
from pymdo.utils.array_and_dict_utils import copy_dict_1d, copy_dict_2d
from pymdo.utils.jac_utils import finite_difference_approx, complex_step_approx
from pymdo.utils.jac_utils import initialize_dense_jac
...
class Discipline:
    ...
    def __init__(self, name: str, input_vars: List[Variable], output_vars: List[Variable],
        ...
        Args:
            name (str): Discipline name by which it is accessed.
    ...
    def _sanitize_inputs(self, input_values: Dict[str, ndarray]):
        ...
        * Check that no values are missing and that the sizes
        ...
        self._values = verify_dict_1d(self.input_vars, self._values, self._dtype)
    ...
    def eval(self, input_values: Dict[str, ndarray] = None) -> Dict[str, ndarray]:
        ...
        * The default values are updated by the current inputs, if evaluation is succeeds.
        ...
        # Verify the outputs and increment eval count
        self._values = verify_dict_1d(self.output_vars, self._values, self._dtype)
